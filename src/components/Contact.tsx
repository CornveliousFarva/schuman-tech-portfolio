      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-white p-6 shadow-sm dark:bg-slate-900">
          ...
          <p className="mt-3 text-slate-600 dark:text-slate-300">
            You can email me directly or copy my email address.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <button
              type="button"
              onClick={copyEmail}
              className="flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-3 font-medium text-white transition hover:bg-emerald-700"
            >
              {copied ? (
                <>
                  <CheckCircle size={18} />
